...
print("Youre numbers added together make up", int(number_1) + int(number_2)) 
print("Your numbers multiplied together make up", int(number_1) * int(number_2))
print("The bigger number is ", (max (int(number_1), int(number_2))))
print("The reminder of your numbers", (int(number_1)%int(number_2)))
print("Your number rounded is"), round(int(number_1), int(number_2))
